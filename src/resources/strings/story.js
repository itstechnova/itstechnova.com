const ourStoryStrings = {
    ...
    quote2Name: "Ayla Orucevic",
    quote2Role: "Experienced Hacker",
    quote3Text: "As a TechNova mentor, you will be a part of an amazing community that aims to empower underrepresented genders in technology. There is nothing more meaningful than contributing to a gender-equitable future and helping these future leaders to kickstart their careers in tech!",
    quote3Name: "Annie Zhou",
    quote3Role: "Mentor",
    affiliatedTitle: "Affiliated with the University of Waterloo’s...",
    wicsTitle: "Women in Computer Science",
    wicsDescription: "In partnership with the University of Waterloo’s Cheriton School of Computer Science - Women in Computer Science(WiCS). WiCS is dedicated to promoting gender equity for those who are interested in studying computer science and who seek to pursue careers in computing.",
